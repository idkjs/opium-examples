...
let index_view = (~success=false, ()) => {
  open Tyxml.Html;
  let a_custom = (x, y) => Xml.string_attrib(x, y) |> to_attrib;
  let a_svg_custom = (x, y) =>
    Tyxml.Xml.string_attrib(x, y) |> Tyxml.Svg.to_attrib;
  layout(
    ...
    [
      if (success) {
        div(
          ~a=[
            a_class(["mx-auto mt-16 max-w-lg rounded-md bg-green-50 p-4"]),
          ],
          [
            div(
              ~a=[a_class(["flex"])],
                ...
                div(
                  ...
                  [
                    p(
                      ~a=[
                        a_class([
                          "text-sm leading-5 font-medium text-green-800",
                        ]),
                      ],
      ...
      form(
        ...
        [
          div(
            ~a=[
              a_class([
                "mx-auto mt-16 max-w-lg justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md",
              ]),
            ],
            [
              div(
                ...
                [
                  label(
                    ~a=[
                      ...
                      a_class([
                        "inline-block cursor-pointer font-medium text-gray-500 hover:text-gray-400 focus:outline-none focus:underline transition duration-150 ease-in-out",
                      ]),
                    ],
                    [
                      span(
                            ...
                            [
                              button(
                                ~a=[
                                  ...
                                  a_class([
                                    "inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white transition ease-in-out duration-150 bg-indigo-300 pointer-events-none",
                                  ]),
                                  a_custom(
                                    ":class",
                                    "{'inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white transition ease-in-out duration-150' : true, 'bg-indigo-300 pointer-events-none': fileName === '','': fileName === '','bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700': fileName !== '' }",
                                  ),
                                ],
                                [txt("Upload")],
                              ),
