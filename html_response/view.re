let layout = (~title as title_, body_) =>
  Tyxml.Html.(
    html(
      ~a=[a_lang("en")],
      head(
                      ...
                      [
                        div([
                          p(
                            ~a=[
                              a_class([
                                "mt-1 text-3xl leading-10 font-extrabold text-gray-900 sm:text-4xl sm:leading-none sm:tracking-tight lg:text-5xl",
                              ]),
                            ],
                            [txt("Opium")],
                          ),
                                    ...
                                    li(
                                      ...
                                      [
                                        ...
                                        p(
                                          ...
                                          [
                                            txt(
                                              "Dozens of middlewares ready to use",
                                            ),
                                          ],
                                        ),
                                      ],
